...
df = spark.read.csv("E:\\Dev\PySpark-Project\\PySpark-Project\\brewery_data_complete_extended.csv", header=True, inferSchema=True)
...
# More advanced analytics can involve joining with other DataFrames, grouping, and aggregating data based on specific criteria.
#Finding average sales per location:
